        ...
        game: {
            data: {
                description: {
                    ...
                    MathMemory: {
                        about: "V porovnaní s predchádzajúcou hrou, Math Memory je komplikovanejšia a kladie <span class='text-slate-600 font-bold'> väčší dôraz na manipuláciu s jednoduchými matematickými výrazmi v krátkodobom pamäťovom systéme </span> . To znamená, že hráči sa spoliehajú hlavne na svoju pracovnú pamäť, ktorá im umožnuje ponechanie si informácií, zatiaľ čo venujú pozornosť inému výrazu. Hra tiež navádza hráča v krátkom čase <span class='text-slate-600 font-bold'> hľadať v sekvencii výrazov rôzne vzory a techniky</span>, pre ulahčenie zapamätávania. Hra kombinuje trénovanie rýchlosti spracovania a trénovanie pracovnej pamäte",
